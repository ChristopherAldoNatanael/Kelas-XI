...
if (isset($data['summary'])) {
    echo PHP_EOL . "=== SUMMARY (No more Pending!) ===" . PHP_EOL;
    ...
    echo "Pending Count exists? " . (isset($data['summary']['pending_count']) ? 'YES: ' . $data['summary']['pending_count'] : 'NO (REMOVED)') . PHP_EOL;
}

if (isset($data['grouped_by_class'])) {
    echo PHP_EOL . "=== GROUPED BY CLASS ===" . PHP_EOL;
    echo "Total classes: " . count($data['grouped_by_class']) . PHP_EOL;
