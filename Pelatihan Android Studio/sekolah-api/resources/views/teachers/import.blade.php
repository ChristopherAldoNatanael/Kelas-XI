...
<div class="min-h-screen">
    ...
    <div class="relative overflow-hidden rounded-3xl mx-6 mb-8">
        <!-- Background Layers -->
        <div class="absolute inset-0 bg-gradient-to-br from-blue-900 via-indigo-800 to-blue-900"></div>
        ...
        <div class="absolute bottom-0 left-0 w-80 h-80 bg-indigo-500/10 rounded-full blur-3xl animate-pulse" style="animation-delay: 2s;"></div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-white/70 text-lg md:text-xl leading-relaxed max-w-2xl">
                            Upload CSV files to bulk import teachers into your system. Supports validation, error handling, and progress tracking.
                        </p>
                    </div>
            ...
            <div class="p-6">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-slate-300">Select your CSV file to import teachers</p>
                        <p class="text-amber-300 text-sm mt-1">💡 For Excel files: Save as CSV format in Excel (File → Save As → CSV)</p>
                    </div>
                </div>

                <form id="importForm" method="POST" action="{{ route('web-teachers.import.store') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="text-slate-400 text-sm mt-1">Skip teachers with existing email addresses</p>
                        </div>

                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" name="update_existing" value="1" class="glass-checkbox">
                                <span class="ml-3 text-white">Update existing teachers</span>
                            </label>
                            <p class="text-slate-400 text-sm mt-1">Update teacher data if email already exists</p>
                        </div>
                    </div>
        ...
        <div class="glass-morphism-card">
            <div class="p-6">
                ...
                <div class="flex gap-4">
                    <a href="{{ route('web-teachers.import.template', ['format' => 'csv']) }}" class="glass-action-btn glass-action-secondary">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <ul class="space-y-2 text-slate-300">
                            ...
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-400 mr-2"></i>
                                <span><strong>nip:</strong> Teacher ID number</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-400 mr-2"></i>
                                <span><strong>teacher_code:</strong> Unique teacher code</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-400 mr-2"></i>
                            ...
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-400 mr-2"></i>
                                <span><strong>join_date:</strong> Join date (YYYY-MM-DD)</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-slate-300">
                            <li class="flex items-center">
                                ...
                                <span><strong>expertise:</strong> Subject expertise</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-minus text-slate-400 mr-2"></i>
                                <span><strong>certification:</strong> Certification details</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-minus text-slate-400 mr-2"></i>
                                <span><strong>status:</strong> active, inactive, or retired</span>
                            </li>
                        </ul>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    importForm.addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            if (data.success) {
                addStatusMessage('success', `Import completed! ${data.processed} teachers processed.`);
