                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-white/70 text-lg md:text-xl leading-relaxed max-w-2xl">
                            Upload CSV files to bulk import academic subjects into your curriculum. Supports validation, error handling, and progress tracking.
                        </p>
                    </div>
                ...
                <div class="lg:shrink-0">
                    <a href="{{ route('web-subjects.index') }}" class="glass-action-button group">
                        ...
                        <div>
                            ...
                            <div class="text-slate-300 text-sm">View all subjects</div>
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div class="p-6">
                <div class="flex items-center gap-4 mb-6">
                    <div class="p-3 rounded-xl bg-gradient-to-br from-emerald-500/20 to-teal-500/20 border border-emerald-400/20">
                        <i class="fas fa-upload text-emerald-300 text-xl"></i>
                    </div>
                    <div>
                        <h3 class="text-xl font-bold text-white">File Upload</h3>
                        <p class="text-slate-300">Select your CSV file to import subjects</p>
                        <p class="text-amber-300 text-sm mt-1">💡 For Excel files: Save as CSV format in Excel (File → Save As → CSV)</p>
                    </div>
                </div>

                <form id="importForm" method="POST" action="{{ route('web-subjects.import.store') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        <label for="file" class="block text-sm font-medium text-white mb-2">
                            <span class="flex items-center">
                                <i class="fas fa-file-upload mr-2 text-emerald-400"></i>
                                Select File
                            </span>
                        </label>
                        <div class="relative">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="flex items-center">
                                ...
                                <span class="ml-3 text-white">Skip duplicate subjects</span>
                            </label>
                            <p class="text-slate-400 text-sm mt-1">Skip subjects with existing codes or names</p>
                        </div>

                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" name="update_existing" value="1" class="glass-checkbox">
                                <span class="ml-3 text-white">Update existing subjects</span>
                            </label>
                            <p class="text-slate-400 text-sm mt-1">Update subject data if code or name already exists</p>
                        </div>
                    </div>
            ...
            <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="w-full bg-slate-700 rounded-full h-3">
                        <div class="bg-gradient-to-r from-emerald-500 to-teal-500 h-3 rounded-full transition-all duration-300" id="progressBar" style="width: 0%"></div>
                    </div>
                </div>
        ...
        <div class="glass-morphism-card">
            <div class="p-6">
                ...
                <div class="flex gap-4">
                    <a href="{{ route('web-subjects.import.template', ['format' => 'csv']) }}" class="glass-action-btn glass-action-secondary">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-slate-300">
                            <li class="flex items-center">
                                ...
                                <span><strong>nama:</strong> Subject name</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-400 mr-2"></i>
                                <span><strong>kode:</strong> Subject code</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-slate-300">
                            <li class="flex items-center">
                                ...
                                <span><strong>category:</strong> wajib, peminatan, or mulok</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-minus text-slate-400 mr-2"></i>
                                <span><strong>description:</strong> Subject description</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-minus text-slate-400 mr-2"></i>
                                <span><strong>credit_hours:</strong> Number of credit hours</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-minus text-slate-400 mr-2"></i>
                                <span><strong>semester:</strong> Semester number</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-minus text-slate-400 mr-2"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    importForm.addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            if (data.success) {
                addStatusMessage('success', `Import completed! ${data.processed} subjects processed.`);
