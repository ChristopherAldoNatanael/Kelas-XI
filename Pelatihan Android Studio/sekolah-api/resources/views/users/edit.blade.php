...
<div class="min-h-screen">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                <div class="space-y-4">
                    <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20">
                        ...
                        <span class="text-white/90 text-sm font-medium">Editing User</span>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-white/70 text-lg md:text-xl leading-relaxed max-w-2xl">
                            Update {{ $user->name }}'s information, permissions, and account settings. Make changes carefully to ensure system integrity.
                        </p>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-4 pt-4">
                        ...
                        <div class="glass-stat-card">
                            ...
                            <div class="text-white/70 text-sm">Current Role</div>
                        </div>
                        <div class="glass-stat-card">
                            <div class="text-2xl font-bold text-white">{{ $user->is_banned ? 'Banned' : 'Active' }}</div>
                            <div class="text-white/70 text-sm">Account Status</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:shrink-0">
                    <div class="flex flex-col gap-4">
                        <a href="{{ route('web-users.show', $user->id) }}" class="glass-action-button group">
    ...
    <div class="px-6 space-y-8">
        ...
        <div class="glass-morphism-card">
            <div class="p-8">
                <div class="mb-8">
                    <h2 class="text-3xl font-bold text-white mb-3">Update User Information</h2>
                    <p class="text-slate-300 text-lg">Modify {{ $user->name }}'s details, permissions, and account settings</p>
                </div>

                <form method="POST" action="{{ route('web-users.update', $user->id) }}" class="space-y-8" id="editUserForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="glass-form-section">
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-slate-300">Update basic user details and contact information</p>
                            </div>
                        </div>
                    ...
                    <div class="glass-form-section">
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-slate-300">Update password (leave blank to keep current password)</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="glass-form-group">
                                ...
                                @error('password')
                                    <div class="glass-error-message">{{ $message }}</div>
                                @enderror
                                <div class="glass-help-text">Leave blank to keep current password</div>
                            </div>
                    ...
                    <div class="glass-form-section">
                        <div class="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-slate-300">Update user role and access permissions</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="glass-form-group" id="class-field" style="display: {{ old('role', $user->role) == 'siswa' ? 'block' : 'none' }};">
                                <label for="class_id" class="glass-form-label">
                                    <i class="fas fa-school mr-2 text-indigo-400"></i>
                                    Kelas <span class="text-red-400">*</span>
                                </label>
                                <select class="glass-form-select @error('class_id') glass-form-error @enderror" id="class_id" name="class_id" {{ old('role', $user->role) == 'siswa' ? 'required' : '' }}>
