...
<div class="min-h-screen">
    ...
    <div class="relative overflow-hidden rounded-3xl mx-6 mb-8">
        <!-- Background Layers -->
        <div class="absolute inset-0 bg-gradient-to-br from-green-900 via-emerald-800 to-green-900"></div>
        ...
        <div class="absolute bottom-0 left-0 w-80 h-80 bg-green-500/10 rounded-full blur-3xl animate-pulse" style="animation-delay: 2s;"></div>
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-teal-500/5 rounded-full blur-2xl animate-pulse" style="animation-delay: 4s;"></div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-white/70 text-lg md:text-xl leading-relaxed max-w-2xl">
                            Upload CSV or Excel files to bulk import users into your system. Supports validation, error handling, and progress tracking.
                        </p>
                    </div>

                    <div class="flex flex-wrap gap-4 pt-4">
                        <div class="glass-stat-card">
                            <div class="text-2xl font-bold text-white">CSV</div>
            ...
            <div class="p-6">
                <div class="flex items-center gap-4 mb-6">
                    <div class="p-3 rounded-xl bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-400/20">
                        <i class="fas fa-upload text-green-300 text-xl"></i>
                    </div>
                    <div>
                        <h3 class="text-xl font-bold text-white">File Upload</h3>
                        <p class="text-slate-300">Select your CSV file to import users</p>
                        <p class="text-amber-300 text-sm mt-1">💡 For Excel files: Save as CSV format in Excel (File → Save As → CSV)</p>
                    </div>
                </div>

                <form id="importForm" method="POST" action="{{ route('web-users.import.store') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        <label for="file" class="block text-sm font-medium text-white mb-2">
                            <span class="flex items-center">
                                <i class="fas fa-file-upload mr-2 text-green-400"></i>
                                Select File
                            </span>
                        </label>
                        <div class="relative">
                            ...
                            <label for="file" class="glass-file-input cursor-pointer">
                                <div class="flex items-center justify-center gap-4 py-8">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-slate-400 text-sm">CSV files up to 10MB (Excel: convert to CSV first)</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="flex items-center">
                                ...
                                <span class="ml-3 text-white">Skip duplicate emails</span>
                            </label>
                            <p class="text-slate-400 text-sm mt-1">Skip users with existing email addresses</p>
                        </div>

                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" name="update_existing" value="1" class="glass-checkbox">
                                <span class="ml-3 text-white">Update existing users</span>
                            </label>
                            <p class="text-slate-400 text-sm mt-1">Update user data if email already exists</p>
                        </div>
                    </div>
        ...
        <div class="glass-morphism-card">
            <div class="p-6">
                ...
                <div class="flex gap-4">
                    <a href="{{ route('web-users.import.template', ['format' => 'csv']) }}" class="glass-action-btn glass-action-secondary">
                        <i class="fas fa-file-csv mr-2"></i>
                        CSV Template
                    </a>
                    <a href="{{ route('web-users.import.template', ['format' => 'xlsx']) }}" class="glass-action-btn glass-action-secondary">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-slate-300">
                            <li class="flex items-center">
                                ...
                                <span><strong>nama:</strong> Full name</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-400 mr-2"></i>
                            ...
                            <li class="flex items-center">
                                <i class="fas fa-check text-green-400 mr-2"></i>
                                <span><strong>role:</strong> admin, kurikulum, siswa, or kepala_sekolah</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-slate-300">
                            <li class="flex items-center">
                                ...
                                <span><strong>password:</strong> Plain text password</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-minus text-slate-400 mr-2"></i>
                                <span><strong>class_id:</strong> Required for students</span>
                            </li>
                            <li class="flex items-center">
                                <i class="fas fa-minus text-slate-400 mr-2"></i>
                                <span><strong>is_banned:</strong> 0 or 1</span>
                            </li>
                        </ul>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    importForm.addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            if (data.success) {
                addStatusMessage('success', `Import completed! ${data.processed} users processed.`);
