...
@section('title', 'Add Service - PetHeal Admin')
...
<div class="glass-card rounded-2xl overflow-hidden border border-slate-200/50">
    <div class="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-slate-400 mt-0.5">Add a new service to the pricelist</p>
        </div>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-primary focus:border-transparent text-sm outline-none transition-all">{{ old('description') }}</textarea>
                </div>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <select name="category" id="category"
                        ...
                        <option value="Medical Checkup" {{ old('category') == 'Medical Checkup' ? 'selected' : '' }}>Medical Checkup</option>
                        ...
                        <option value="Lab Test" {{ old('category') == 'Lab Test' ? 'selected' : '' }}>Lab Test</option>
